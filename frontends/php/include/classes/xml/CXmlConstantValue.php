...
class CXmlConstantValue {
	...
	const TRIGGER_EXPRESSION = TRX_RECOVERY_MODE_EXPRESSION;
	const TRIGGER_RECOVERY_EXPRESSION = TRX_RECOVERY_MODE_RECOVERY_EXPRESSION;
	const TRIGGER_NONE = TRX_RECOVERY_MODE_NONE; // Duplicate.

	const TRIGGER_DISABLED = TRX_TRIGGER_CORRELATION_NONE; // Duplicate.
	const TRIGGER_TAG_VALUE = TRX_TRIGGER_CORRELATION_TAG;
	...
	const RAW = TRX_POSTTYPE_RAW;
	const JSON = TRX_POSTTYPE_JSON;
	const XML = TRX_POSTTYPE_XML;
	...
	const ORIGINAL_ERROR = TRX_PREPROC_FAIL_DEFAULT;
	const DISCARD_VALUE = TRX_PREPROC_FAIL_DISCARD_VALUE;
	const CUSTOM_VALUE = TRX_PREPROC_FAIL_SET_VALUE;
	const CUSTOM_ERROR = TRX_PREPROC_FAIL_SET_ERROR;

	const MULTIPLIER = TRX_PREPROC_MULTIPLIER;
	const RTRIM = TRX_PREPROC_RTRIM;
	const LTRIM = TRX_PREPROC_LTRIM;
	const TRIM = TRX_PREPROC_TRIM;
	const REGEX = TRX_PREPROC_REGSUB;
	const BOOL_TO_DECIMAL = TRX_PREPROC_BOOL2DEC;
	const OCTAL_TO_DECIMAL = TRX_PREPROC_OCT2DEC;
	const HEX_TO_DECIMAL = TRX_PREPROC_HEX2DEC;
	const SIMPLE_CHANGE = TRX_PREPROC_DELTA_VALUE;
	const CHANGE_PER_SECOND = TRX_PREPROC_DELTA_SPEED;
	const XMLPATH = TRX_PREPROC_XPATH;
	const JSONPATH = TRX_PREPROC_JSONPATH;
	const IN_RANGE = TRX_PREPROC_VALIDATE_RANGE;
	const MATCHES_REGEX = TRX_PREPROC_VALIDATE_REGEX;
	const NOT_MATCHES_REGEX = TRX_PREPROC_VALIDATE_NOT_REGEX;
	const CHECK_JSON_ERROR = TRX_PREPROC_ERROR_FIELD_JSON;
	const CHECK_XML_ERROR = TRX_PREPROC_ERROR_FIELD_XML;
	const CHECK_REGEX_ERROR = TRX_PREPROC_ERROR_FIELD_REGEX;
	const DISCARD_UNCHANGED = TRX_PREPROC_THROTTLE_VALUE;
	const DISCARD_UNCHANGED_HEARTBEAT = TRX_PREPROC_THROTTLE_TIMED_VALUE;
	const JAVASCRIPT = TRX_PREPROC_SCRIPT;
	const PROMETHEUS_PATTERN = TRX_PREPROC_PROMETHEUS_PATTERN;
	const PROMETHEUS_TO_JSON = TRX_PREPROC_PROMETHEUS_TO_JSON;
	const CSV_TO_JSON = TRX_PREPROC_CSV_TO_JSON;
