...
$triggersFormList
	...
	->addRow(
		...
		(new CTextBox('opdata', $data['opdata'], $readonly))->setWidth(TRX_TEXTAREA_STANDARD_WIDTH)
	);
...
$triggersFormList
	->addRow(_('URL'), (new CTextBox('url', $data['url'], $discovered_trigger))->setWidth(TRX_TEXTAREA_STANDARD_WIDTH))
