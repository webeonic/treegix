...
class CControllerAcknowledgeEdit extends CController {
	...
	protected function doAction() {
		$data = [
			...
			'scope' => (int) $this->getInput('scope', TRX_ACKNOWLEDGE_SELECTED),
			'backurl' => $this->getInput('backurl', 'treegix.php?action=problem.view'),
			'change_severity' => $this->getInput('change_severity', TRX_PROBLEM_UPDATE_NONE),
			'severity' => $this->hasInput('severity') ? (int) $this->getInput('severity') : null,
			'acknowledge_problem' => $this->getInput('acknowledge_problem', TRX_PROBLEM_UPDATE_NONE),
			'close_problem' => $this->getInput('close_problem', TRX_PROBLEM_UPDATE_NONE),
		...
		$triggerids = array_keys(array_flip(trx_objectValues($events, 'objectid')));
