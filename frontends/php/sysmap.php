...
$fields = [
	'sysmapid' =>	[T_TRX_INT, O_MAND, P_SYS,	DB_ID,		null],
	'selementid' =>	[T_TRX_INT, O_OPT, P_SYS,	DB_ID,		null],
	'sysmap' =>		[T_TRX_STR, O_OPT, null,	NOT_EMPTY,	'isset({action}) && {action} == "update"'],
	'selements' =>	[T_TRX_STR, O_OPT, P_SYS,	null,		null],
	'links' =>		[T_TRX_STR, O_OPT, P_SYS,	null,		null],
	// actions
	'action' =>		[T_TRX_STR, O_OPT, P_ACT,	IN('"update","expand"'),	null],
	...
	// ajax
	'favobj' =>		[T_TRX_STR, O_OPT, P_ACT,	null,		null],
	'favid' =>		[T_TRX_STR, O_OPT, P_ACT,	null,		null],
	'source' =>		[T_TRX_STR, O_OPT, null,	NOT_EMPTY,	'isset({action}) && {action} == "expand"'],
];
check_fields($fields);
