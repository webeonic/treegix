...
import (
	...
	"treegix/internal/agent/remotecontrol"
	"treegix/internal/agent/scheduler"
	"treegix/internal/agent/serverconnector"
	"treegix/internal/agent/serverlistener"
	"treegix/internal/agent/statuslistener"
...
func main() {
	...
	const (
		...
		foregroundDescription = "Run Treegix agent in foreground"
	)
	...
	farewell := fmt.Sprintf("Treegix Agent 2 stopped. (%s)", version.Long())
	log.Infof(farewell)
