...
func (p *Plugin) Export(key string, params []string, ctx plugin.ContextProvider) (interface{}, error) {
	...
	resp, err := p.getRemoteTreegixStats(addr, req)
...
func init() {
	plugin.RegisterMetrics(&impl, "TreegixStats", "treegix.stats", "Return a set of Treegix server or proxy internal "+
		"metrics or return number of monitored items in the queue which are delayed on Treegix server or proxy.")
}
