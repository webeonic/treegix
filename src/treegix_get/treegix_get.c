...
const char	title_message[] = "treegix_get";
const char	syslog_app_name[] = "treegix_get";
...
const char	*help_message[] = {
	...
	"                             key",
#else
	"  Not available. This 'treegix_get' was compiled without TLS support",
#endif
	"",
	"Example(s):",
...
int	CONFIG_PASSIVE_FORKS		= 0;	/* not used in treegix_get, just for linking with tls.c */
int	CONFIG_ACTIVE_FORKS		= 0;	/* not used in treegix_get, just for linking with tls.c */
 ...
 * Function: get_value                                                        *
 *                                                                            *
 * Purpose: connect to Treegix agent, receive and print value                  *
 *                                                                            *
