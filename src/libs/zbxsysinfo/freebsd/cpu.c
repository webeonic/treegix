...
int     SYSTEM_CPU_SWITCHES(AGENT_REQUEST *request, AGENT_RESULT *result)
{
	...
	{
		SET_MSG_RESULT(result, trx_dsprintf(NULL, "Cannot obtain \"vm.stats.sys.v_swtch\" system parameter: %s",
				trx_strerror(errno)));
		return SYSINFO_RET_FAIL;
	}
...
int     SYSTEM_CPU_INTR(AGENT_REQUEST *request, AGENT_RESULT *result)
{
	...
	{
		SET_MSG_RESULT(result, trx_dsprintf(NULL, "Cannot obtain \"vm.stats.sys.v_intr\" system parameter: %s",
				trx_strerror(errno)));
		return SYSINFO_RET_FAIL;
	}
