...
{
	const TRX_FIELD	field = {"proxy_address", "", NULL, NULL, 255, TRX_TYPE_CHAR, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"name", "", NULL, NULL, 2048, TRX_TYPE_CHAR, TRX_NOTNULL, 0};
...
#define	TRX_DEFAULT_INTERNAL_TRIGGER_EVENT_NAME	"Cannot calculate trigger expression."
#define	TRX_DEFAULT_INTERNAL_ITEM_EVENT_NAME	"Cannot obtain item value."

static int	DBpatch_3050008(void)
{
	int		res;
	char		*trdefault = (char *)TRX_DEFAULT_INTERNAL_TRIGGER_EVENT_NAME;
...
{
	int		res;
	char		*itdefault = (char *)TRX_DEFAULT_INTERNAL_ITEM_EVENT_NAME;
...
{
	const TRX_FIELD	field = {"dns", "", NULL, NULL, 255, TRX_TYPE_CHAR, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"listen_dns", "", NULL, NULL, 255, TRX_TYPE_CHAR, TRX_NOTNULL, 0};
...
#define TRX_COLORPALETTE_LIGHT	"1A7C11,F63100,2774A4,A54F10,FC6EA3,6C59DC,AC8C14,611F27,F230E0,5CCD18,BB2A02,"	\
				"5A2B57,89ABF8,7EC25C,274482,2B5429,8048B4,FD5434,790E1F,87AC4D,E89DF4"
#define TRX_COLORPALETTE_DARK	"199C0D,F63100,2774A4,F7941D,FC6EA3,6C59DC,C7A72D,BA2A5D,F230E0,5CCD18,BB2A02,"	\
...
static int	DBpatch_3050021(void)
{
	...
	if (TRX_DB_OK <= DBexecute(
			...
			" values (1,'blue-theme','FFFFFF','FFFFFF','CCD5D9','ACBBC2','ACBBC2','1F2C33','E33734',"
				"'429E47','E33734','EBEBEB','" TRX_COLORPALETTE_LIGHT "')"))
	{
		return SUCCEED;
	}
...
static int	DBpatch_3050022(void)
{
	...
	if (TRX_DB_OK <= DBexecute(
			...
			" values (2,'dark-theme','2B2B2B','2B2B2B','454545','4F4F4F','4F4F4F','F2F2F2','E45959',"
				"'59DB8F','E45959','333333','" TRX_COLORPALETTE_DARK "')"))
	{
		return SUCCEED;
	}
...
static int	DBpatch_3050023(void)
{
	...
	if (TRX_DB_OK <= DBexecute(
			...
			" values (3,'hc-light','FFFFFF','FFFFFF','555555','000000','333333','000000','333333',"
				"'000000','000000','EBEBEB','" TRX_COLORPALETTE_LIGHT "')"))
	{
		return SUCCEED;
	}
...
static int	DBpatch_3050024(void)
{
	...
	if (TRX_DB_OK <= DBexecute(
			...
			" values (4,'hc-dark','000000','000000','666666','888888','4F4F4F','FFFFFF','FFFFFF',"
				"'FFFFFF','FFFFFF','333333','" TRX_COLORPALETTE_DARK "')"))
	{
		return SUCCEED;
	}
...
#undef TRX_COLORPALETTE_LIGHT
#undef TRX_COLORPALETTE_DARK
...
{
	const TRX_FIELD	field = {"sendto", "", NULL, NULL, 1024, TRX_TYPE_CHAR, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"custom_color", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"problem_unack_color", "CC0000", NULL, NULL, 6, TRX_TYPE_CHAR, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"problem_ack_color", "CC0000", NULL, NULL, 6, TRX_TYPE_CHAR, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"ok_unack_color", "009900", NULL, NULL, 6, TRX_TYPE_CHAR, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"ok_ack_color", "009900", NULL, NULL, 6, TRX_TYPE_CHAR, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"groupid", NULL, "groups", "groupid", 0, 0, 0, TRX_FK_CASCADE_DELETE};
...
{
	const TRX_FIELD field = {"timeout", "3s", NULL, NULL, 255, TRX_TYPE_CHAR, TRX_NOTNULL | TRX_PROXY, 0};
...
{
	const TRX_FIELD field = {"url", "", NULL, NULL, 2048, TRX_TYPE_CHAR, TRX_NOTNULL | TRX_PROXY, 0};
...
{
	const TRX_FIELD field = {"query_fields", "", NULL, NULL, 2048, TRX_TYPE_CHAR, TRX_NOTNULL | TRX_PROXY, 0};
...
{
	const TRX_FIELD	field = {"posts", "", NULL, NULL, 0, TRX_TYPE_SHORTTEXT, TRX_NOTNULL | TRX_PROXY, 0};
...
{
	const TRX_FIELD field = {"status_codes", "200", NULL, NULL, 255, TRX_TYPE_CHAR, TRX_NOTNULL | TRX_PROXY, 0};
...
{
	const TRX_FIELD field = {"follow_redirects", "1", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL | TRX_PROXY, 0};
...
{
	const TRX_FIELD field = {"post_type", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL | TRX_PROXY, 0};
...
{
	const TRX_FIELD field = {"http_proxy", "", NULL, NULL, 255, TRX_TYPE_CHAR, TRX_NOTNULL | TRX_PROXY, 0};
...
{
	const TRX_FIELD	field = {"headers", "", NULL, NULL, 0, TRX_TYPE_SHORTTEXT, TRX_NOTNULL | TRX_PROXY, 0};
...
{
	const TRX_FIELD field = {"retrieve_mode", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL | TRX_PROXY, 0};
...
{
	const TRX_FIELD field = {"request_method", "1", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL | TRX_PROXY, 0};
...
{
	const TRX_FIELD field = {"output_format", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL | TRX_PROXY, 0};
...
{
	const TRX_FIELD field = {"ssl_cert_file", "", NULL, NULL, 255, TRX_TYPE_CHAR, TRX_NOTNULL | TRX_PROXY, 0};
...
{
	const TRX_FIELD field = {"ssl_key_file", "", NULL, NULL, 255, TRX_TYPE_CHAR, TRX_NOTNULL | TRX_PROXY, 0};
...
{
	const TRX_FIELD field = {"ssl_key_password", "", NULL, NULL, 64, TRX_TYPE_CHAR, TRX_NOTNULL | TRX_PROXY, 0};
...
{
	const TRX_FIELD field = {"verify_peer", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL | TRX_PROXY, 0};
...
{
	const TRX_FIELD field = {"verify_host", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL | TRX_PROXY, 0};
...
{
	const TRX_FIELD field = {"allow_traps", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL | TRX_PROXY, 0};
...
{
	const TRX_FIELD	field = {"auto_compress", "1", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
static int	DBpatch_3050066(void)
{
	...
	{
		if (TRX_DB_OK > DBexecute("update widget set type='%s' where type='%s'", types[i + 1], types[i]))
			return FAIL;
	}
...
{
#ifdef HAVE_IBM_DB2
	const TRX_FIELD	field = {"groupid", NULL, "hstgrp", "groupid", 0, 0, 0, 0};
...
{
#ifdef HAVE_IBM_DB2
	const TRX_FIELD	field = {"groupid", NULL, "hstgrp", "groupid", 0, 0, 0, TRX_FK_CASCADE_DELETE};
...
{
#ifdef HAVE_IBM_DB2
	const TRX_FIELD	field = {"discovery_groupid", NULL, "hstgrp", "groupid", 0, 0, 0, 0};
...
{
#ifdef HAVE_IBM_DB2
	const TRX_FIELD	field = {"id",	NULL, "hstgrp", "groupid", 0, 0, 0, TRX_FK_CASCADE_DELETE};
...
{
#ifdef HAVE_IBM_DB2
	const TRX_FIELD	field = {"groupid", NULL, "hstgrp", "groupid", 0, TRX_TYPE_ID, TRX_NOTNULL, 0};
...
{
#ifdef HAVE_IBM_DB2
	const TRX_FIELD	field = {"value_groupid", NULL, "hstgrp", "groupid", 0, 0, 0, TRX_FK_CASCADE_DELETE};
...
{
	const TRX_FIELD	field = {"name", "", NULL, NULL, 12, TRX_TYPE_CHAR, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"ok_period", "5m", NULL, NULL, 32, TRX_TYPE_CHAR, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"blink_period", "2m", NULL, NULL, 32, TRX_TYPE_CHAR, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"severity", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"acknowledged", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"old_severity", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"new_severity", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"request_method", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
		...
		{"event_suppress", "event_suppressid",	0,
			{
				...
				{"maintenanceid", NULL, NULL, NULL, 0, TRX_TYPE_ID, 0, 0},
...
{
	const TRX_FIELD	field = {"maintenanceid", NULL, "maintenances", "maintenanceid", 0, 0, 0, TRX_FK_CASCADE_DELETE};
...
{
	const TRX_FIELD	field = {"show_suppressed", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"tags_evaltype", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"pause_suppressed", "1", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"http_auth_enabled", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"http_login_form", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"http_strip_domains", "", NULL, NULL, 2048, TRX_TYPE_CHAR, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"http_case_sensitive", "1", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"ldap_configured", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"ldap_case_sensitive", "1", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
static int	DBpatch_3050153(void)
{
	...
	/* Change TRX_AUTH_HTTP to TRX_AUTH_INTERNAL and enable HTTP_AUTH option. */
...
static int	DBpatch_3050155(void)
{
	...
	/* Update ldap_configured to TRX_AUTH_LDAP_ENABLED for config with default authentication type TRX_AUTH_LDAP. */
	/* Update ldap_case_sensitive to TRX_AUTH_CASE_SENSITIVE. */
...
{
	const TRX_FIELD	field = {"passwd", "", NULL, NULL, 32, TRX_TYPE_CHAR, TRX_NOTNULL, 0};
