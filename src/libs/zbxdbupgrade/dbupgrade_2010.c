...
static int	DBmodify_proxy_table_id_field(const char *table_name)
{
	...
	const TRX_FIELD	field = {"id", NULL, NULL, NULL, 0, TRX_TYPE_ID, TRX_NOTNULL, 0};
...
static int	DBpatch_2010007(void)
{
	...
	{
		if (TRX_DB_OK > DBexecute("update profiles set idx='web.screens.%s' where idx='web.charts.%s'",
				strings[i], strings[i]))
		{
			return FAIL;
		}
...
{
	const TRX_FIELD	field = {"expression", "", NULL, NULL, 2048, TRX_TYPE_CHAR, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"applicationid", NULL, NULL, NULL, 0, TRX_TYPE_ID, 0, 0};
...
{
	const TRX_FIELD	field = {"hostid", NULL, NULL, NULL, 0, TRX_TYPE_ID, 0, 0};
...
{
	const TRX_FIELD	field = {"hostid", NULL, NULL, NULL, 0, TRX_TYPE_ID, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"templateid", NULL, NULL, NULL, 0, TRX_TYPE_ID, 0, 0};
...
{
	const TRX_FIELD	field = {"applicationid", NULL, "applications", "applicationid", 0, 0, 0, 0};
...
{
	const TRX_FIELD	field = {"templateid", NULL, "httptest", "httptestid", 0, 0, 0, TRX_FK_CASCADE_DELETE};
...
{
	const TRX_FIELD	field = {"http_proxy", "", NULL, NULL, 255, TRX_TYPE_CHAR, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD field = {"snmpv3_authprotocol", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD field = {"snmpv3_privprotocol", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD field = {"retries", "1", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	if (TRX_DB_OK <= DBexecute("update config set server_check_interval=10"))
		return SUCCEED;
...
{
	const TRX_FIELD	field = {"server_check_interval", "10", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"state", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"itemid", NULL, NULL, NULL, 0, TRX_TYPE_ID, 0, 0};
...
{
	const TRX_FIELD field = {"hk_events_mode", "1", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD field = {"hk_events_trigger", "365", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD field = {"hk_events_internal", "365", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD field = {"hk_events_discovery", "365", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD field = {"hk_events_autoreg", "365", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD field = {"hk_services_mode", "1", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD field = {"hk_services", "365", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD field = {"hk_audit_mode", "1", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD field = {"hk_audit", "365", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD field = {"hk_sessions_mode", "1", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD field = {"hk_sessions", "365", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD field = {"hk_history_mode", "1", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD field = {"hk_history_global", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD field = {"hk_history", "90", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD field = {"hk_trends_mode", "1", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD field = {"hk_trends_global", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD field = {"hk_trends", "365", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"snmpv3_contextname", "", NULL, NULL, 255, TRX_TYPE_CHAR, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"variables", "", NULL, NULL, 0, TRX_TYPE_SHORTTEXT, TRX_NOTNULL, 0};
			...
			{"application_template", "application_templateid", 0,
				{
					...
					{"templateid", NULL, NULL, NULL, 0, TRX_TYPE_ID, TRX_NOTNULL, 0},
					{NULL}
				},
				NULL
			};
...
{
	const TRX_FIELD	field = {"applicationid", NULL, "applications", "applicationid", 0, 0, 0, TRX_FK_CASCADE_DELETE};
...
{
	const TRX_FIELD	field = {"templateid", NULL, "applications", "applicationid", 0, 0, 0, TRX_FK_CASCADE_DELETE};
...
{
	const TRX_FIELD field = {"severity_min", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"host_metadata", "", NULL, NULL, 255, TRX_TYPE_CHAR, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"width", "900", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"height", "200", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	if (TRX_DB_OK <= DBexecute("update items set history=1 where history=0"))
	{
		return SUCCEED;
	}
...
static int	DBpatch_2010101(void)
{
	...
	while (NULL != (row = DBfetch(result)) && SUCCEED == ret)
	{
		...
		if (NULL == error_message)
		{
			...
			if (TRX_DB_OK > DBexecute("update items set username='%s',password='%s',key_='%s',params='%s'"
			...
			{"host_discovery", "hostid", 0,
				{
					...
					{"parent_hostid", NULL, NULL, NULL, 0, TRX_TYPE_ID, 0, 0},
					{"parent_itemid", NULL, NULL, NULL, 0, TRX_TYPE_ID, 0, 0},
					{"host", "", NULL, NULL, 64, TRX_TYPE_CHAR, TRX_NOTNULL, 0},
...
{
	const TRX_FIELD	field = {"parent_hostid", NULL, "hosts", "hostid", 0, 0, 0, 0};
...
{
	const TRX_FIELD	field = {"parent_itemid", NULL, "items", "itemid", 0, 0, 0, 0};
...
{
	const TRX_FIELD	field = {"templateid", NULL, "hosts", "hostid", 0, 0, 0, TRX_FK_CASCADE_DELETE};
			...
			{"interface_discovery", "interfaceid", 0,
				{
					...
					{"parent_interfaceid", NULL, NULL, NULL, 0, TRX_TYPE_ID, TRX_NOTNULL, 0},
					{NULL}
				},
				NULL
			};
...
{
	const TRX_FIELD	field = {"interfaceid", NULL, "interface", "interfaceid", 0, 0, 0, TRX_FK_CASCADE_DELETE};
...
static int	DBpatch_2010166(void)
{
	const TRX_FIELD	field =
			{"parent_interfaceid", NULL, "interface", "interfaceid", 0, 0, 0, TRX_FK_CASCADE_DELETE};
			...
			{"group_prototype", "group_prototypeid", 0,
				{
					...
					{"groupid", NULL, NULL, NULL, 0, TRX_TYPE_ID, 0, 0},
...
{
	const TRX_FIELD	field = {"templateid", NULL, "group_prototype", "group_prototypeid", 0, 0, 0, TRX_FK_CASCADE_DELETE};
			...
			{"group_discovery", "groupid", 0,
				{
					...
					{"parent_group_prototypeid", NULL, NULL, NULL, 0, TRX_TYPE_ID, TRX_NOTNULL, 0},
					{"name", "", NULL, NULL, 64, TRX_TYPE_CHAR, TRX_NOTNULL, 0},
					{"lastcheck", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0},
					{"ts_delete", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0},
					{NULL}
...
{
	const TRX_FIELD	field = {"parent_group_prototypeid", NULL, "group_prototype", "group_prototypeid", 0, 0, 0, 0};
...
{
	const TRX_FIELD	field = {"yaxismax", "100", NULL, NULL, 0, TRX_TYPE_FLOAT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"yaxisside", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"ip", "127.0.0.1", NULL, NULL, 64, TRX_TYPE_CHAR, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"label", "", NULL, NULL, 2048, TRX_TYPE_CHAR, TRX_NOTNULL, 0};
...
{
	const TRX_FIELD	field = {"label_location", "0", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
	if (TRX_DB_OK > DBexecute("update sysmaps_elements set label_location=-1 where label_location is null"))
		return FAIL;
...
{
	const TRX_FIELD	field = {"label_location", "-1", NULL, NULL, 0, TRX_TYPE_INT, TRX_NOTNULL, 0};
...
{
#ifdef HAVE_ORACLE
	const TRX_FIELD	field = {"message_tmp", "", NULL, NULL, 0, TRX_TYPE_TEXT, TRX_NOTNULL, 0};
...
{
#ifdef HAVE_ORACLE
	return TRX_DB_OK > DBexecute("update alerts set message_tmp=message") ? FAIL : SUCCEED;
#else
	return SUCCEED;
#endif
}
...
{
#ifdef HAVE_ORACLE
	const TRX_FIELD	field = {"message", "", NULL, NULL, 0, TRX_TYPE_TEXT, TRX_NOTNULL, 0};
