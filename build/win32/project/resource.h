...
#define VER_FILEVERSION_STR	ZBX_STR(TREEGIX_VERSION_MAJOR) "." ZBX_STR(TREEGIX_VERSION_MINOR) "." \
					ZBX_STR(TREEGIX_VERSION_PATCH) "." ZBX_STR(TREEGIX_VERSION_REVISION) "\0"
#define VER_PRODUCTVERSION	TREEGIX_VERSION_MAJOR,TREEGIX_VERSION_MINOR,TREEGIX_VERSION_PATCH
#define VER_PRODUCTVERSION_STR	ZBX_STR(TREEGIX_VERSION_MAJOR) "." ZBX_STR(TREEGIX_VERSION_MINOR) "." \
					ZBX_STR(TREEGIX_VERSION_PATCH) TREEGIX_VERSION_RC "\0"
